defmodule Animalshelter.Accounts do
  @moduledoc """
  ...
  alias Animalshelter.Accounts.{User, UserToken}
  ...
  See `Animalshelter.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `Animalshelter.Accounts.User.password_changeset/3` for a list of supported options.
